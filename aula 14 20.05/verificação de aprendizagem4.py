...
dia = int(input('Entre com dia, ex 2: '))    
mes = int(input('Entre com mes, ex 11: '))    
ano = int(input('Entre com ano, ex 1998: '))    

dia1(dia)
mes1(mes)
ano1(ano)

print(f"A data digitada por extenso é: {dia1(dia)} de {mes1(mes)} de {ano1(ano)} ")
